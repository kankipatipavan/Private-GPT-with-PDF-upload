...
config_file = r'C:\Users\NGS019\Desktop\your_personal_pdfChat\Chat-with-PDF-Chatbot\models\LaMini-T5-738M\tokenizer_config.json'
token = get_token() 
...
def main():
    ...
    st.markdown("<h3 style='text-align: center; color: grey;'>Built by <a href='https://github.com/Kankipatipavan'>K pavan kumar varma with ❤️ </a></h3>", unsafe_allow_html=True)
